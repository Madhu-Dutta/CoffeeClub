...
GO
/*
The column [dbo].[Records].[Time] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[Records] DROP COLUMN [Time];
...
INSERT INTO Records(Venue, Date, memberID) VALUES ('Cafe Gomez', '11/11/2016', 84 );
